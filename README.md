# Distributed-IM-Core - 分布式高可用即时通讯系统

Distributed-IM-Core 是一款基于 **Go (Gin)** 和 **Vue 3 (Element Plus)** 开发的高性能、分布式即时通讯系统。本项目在原始开源架构的基础上进行了深度重构，引入了多项企业级技术方案，支持海量长连接的水平扩展与消息的可靠投递。
...
1. **克隆项目**
   ```bash
   git clone https://github.com/sjoll2116/Distributed-IM-Core
   cd Distributed-IM-Core
   ```
